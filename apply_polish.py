...
# -*- coding: utf-8 -*-
"""
Take original.docx (V3对外公示版) and apply language polish.
Mark modified text in BLUE (#0055CC).
Titles/section headers stay black (original formatting).
"""
import zipfile
...
DST = '/home/admin/lindy-growth/ddingdong_modified.docx'
...
# ============ DEFINE REPLACEMENTS ============
# Key = original paragraph index, Value = new text (polished)
# Only for body paragraphs that were modified
...
# P5: 叮咚买菜核心理念 - polish (FIRST SENTENCE changed)
replacements[5] = (
...
# P19: 频道内容导语 - minor polish
replacements[19] = (
    '在频道内容方面，设置多重差异化内容方向，鼓励全员投稿，'
    '积极传播食品安全知识与行动成果。'
)

# P25: 智能化服务功能导语 - polish
replacements[25] = (
...
for idx, new_text in replacements.items():
    ...
    color_elem.set('{http://schemas.openxmlformats.org/wordprocessingml/2006/main}val', '0055CC')
    
    # Font
    rfonts = etree.SubElement(rpr, '{http://schemas.openxmlformats.org/wordprocessingml/2006/main}rFonts')
    rfonts.set('{http://schemas.openxmlformats.org/wordprocessingml/2006/main}eastAsia', '\u7b49\u7ebf')
    rfonts.set('{http://schemas.openxmlformats.org/wordprocessingml/2006/main}ascii', '\u7b49\u7ebf')
